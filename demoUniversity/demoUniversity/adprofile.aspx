<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adprofile.aspx.cs" Inherits="demoUniversity.adprofile" %>
  ...
  <li><a href="#">University</a>
    ...
    <li><a href="AbUs.aspx">About Us</a></li>
        ...
        <div style="text-align:center; width:100%;  background-color:#5784BE">
            <div style="font-size:30pt; color: #FFFFCC ; width:inherit; text-shadow:1px 1px 2px">Profile</div>
        </div>
        <br />
        <br />
        <br />

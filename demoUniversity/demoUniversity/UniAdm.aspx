  ...
  <li><a href="#">University</a>
   ...
   <br />
        ...
        <div style="text-align:center; width:100%;  background-color:#5784BE">
            <div style="font-size:30pt; color: #FFFFCC ; width:inherit">Add A Notice</div>
        </div>
        <br />
        <br />
        ...
        <asp:Table ID="Table1" runat="server" HorizontalAlign="Center">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="te"></asp:TextBox><br />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="te"></asp:TextBox><br />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                    <asp:TextBox ID="TextBox3" runat="server" CssClass="te"></asp:TextBox><br />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label ID="Label4" runat="server" Text="Upload a file: "></asp:Label>
                </asp:TableCell>
                <asp:TableCell>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Right" >
                    <asp:Button ID="Button1" runat="server" Text="Upload" OnClick="Button1_Click" BackColor="Green" ForeColor="White" />
                </asp:TableCell>

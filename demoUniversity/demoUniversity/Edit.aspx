...
<body style="background-color: #CCFFFF">
  ...
  <li><a href="#">University</a>
   ...
   <br />
        ...
        <br />
        <asp:Table ID="Table1" runat="server" HorizontalAlign="Center" CellPadding="100">
            <asp:TableRow HorizontalAlign="Center" >
                ...
                <asp:TableCell>
                    <asp:Label ID="Label15" runat="server" Text="Add a new news" ForeColor="#FF6600" Font-Size="25" Font-Bold="True"></asp:Label>
        ...
        <asp:Label ID="Label16" runat="server" Text="Add a way to go" ForeColor="#FF6600" Font-Size="25" Font-Bold="True"></asp:Label>
        ...
        <div style="vertical-align:middle">
            ...
            <asp:Label ID="Label17" runat="server" Text="Place you stay in the city" Font-Size="25" ForeColor="#FF6600" Font-Bold="True"></asp:Label>
